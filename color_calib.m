...
im = imread('macbethcolorchart3.jpg'); % Sample image 
...
tempimage = squaresIm;
%RGB Values
RGB_ValuesGray = [tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),1) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),2) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),3)]
RGB_ValuesGold = [tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),1) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),2) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),3)]

%HSV Values
tempimage = rgb2hsv(squaresIm);
HSV_ValuesGray = [tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),1) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),2) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),3)]
HSV_ValuesGold = [tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),1) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),2) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),3)]

%YCbCr Values
tempimage = rgb2ycbcr(squaresIm);
YCBCR_ValuesGray = [tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),1) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),2) tempimage(floor(meanysorted(4)),floor(meanxsorted(4)),3)]
YCBCR_ValuesGold = [tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),1) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),2) tempimage(floor(meanysorted(2)),floor(meanxsorted(6)),3)]
figure;
imshow(squaresIm);
